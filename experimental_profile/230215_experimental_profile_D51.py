...
setoffsetN = -74.721   # 15N offset in Hz
setoffsetH = -4363.806 # 1H offset in Hz (from water, -1 multiplied to be consistent with Bruker spectrometer)
...
outname = "D51_decay_15N_"+str(setoffsetN)+"_1H_"+str(setoffsetH)+"_"+H_option+"_"+N_option
