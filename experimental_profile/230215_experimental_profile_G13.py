...
setoffsetN = -1051.410  # 15N offset in Hz
setoffsetH = -3540.665 # 1H offset in Hz (from water, -1 multiplied to be consistent with Bruker spectrometer)
...
outname = "G13_decay_15N_"+str(setoffsetN)+"_1H_"+str(setoffsetH)+"_"+H_option+"_"+N_option
